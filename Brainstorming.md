...
* MovieMood – App that recommends movies based on the user’s current mood.
* HydrateMe – Water intake tracker that reminds users to stay hydrated daily.
* StudyBuddy – Pomodoro-style study timer that gives motivational quotes.

Antonio’s Ideas

* Campus Eats – Shows popular nearby food spots and allows students to rate them.
* Fit in 5 – Quick 5-minute workouts with simple animations and routines.
* PackPal – Generates packing checklists based on the type of trip (beach, road trip, etc.).

Ondrea’s Ideas

* PetMatch – Displays adoptable pets from shelters using filters like size and age.
* This or That – Users vote on fun polls (fashion, food, music) and see live results.
* Daily Words – Gives a daily vocabulary word with definition, examples, and pronunciation.

**Step 2a:** Top 3 Ideas Selected for Evaluation

After reviewing all nine ideas, the group voted and selected these top three apps to evaluate:

* MovieMood
* Campus Eats 
* PetMatch

**Step 2b:** Evaluation of the Top 3 Ideas
...
After evaluating all three ideas, the team voted and chose:

 **Final Idea:** MovieMood

**Reason:**

* Fun, creative, and visually appealing

* Clear & simple MVP

* Uses a free, easy API (TheMovieDB)

* Fits well into the timeline and Android Studio skill level

* Everyone on the team liked the concept
